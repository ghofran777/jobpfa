  ...
  return (
    <div className='container 2xl:px-20 px-4 mx-auto my-10'>
      <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-2 justify-between bg-white rounded text-gray-600 max-w-xl px-4 mx-4 sm:mx-auto py-2'>
      ...
      <div className='border border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex justify-center'>
        <div className='flex justify-center gap-6 sm:gap-16 flex-wrap items-center'>
